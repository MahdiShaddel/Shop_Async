        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Family = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    ...
                    PhoneMobile = table.Column<string>(type: "varchar(12)", maxLength: 12, nullable: false),
                    VenderId = table.Column<int>(type: "int", nullable: false),
                    SVender = table.Column<int>(type: "int", nullable: true),
                    STag = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tagnew", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tagnew_Vendor_STag",
                        column: x => x.STag,
                        principalTable: "Vendor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tagnew_Vendor_SVender",
                        column: x => x.SVender,
                        principalTable: "Vendor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
